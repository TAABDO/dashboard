...
$requete=" SELECT * FROM orderes where id = $id ";
...
if(isset($_POST['submit'])){
  ...
  $update="UPDATE `orderes`
  SET `Order_Name`= '$Order_Name', `client_Name`= '$client_Name' , `Location`= '$Location' , `Price`= '$Price' WHERE id = $id ";
...
<form class="formajouter" method="POST" action="orders.php" >
