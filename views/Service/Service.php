...
<head>
    ...
    <!-- =========== Links  =========-->
    <link rel="stylesheet" href="asset/js/Service.css">
            ...
            <div class="row">
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon  "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon1.png" alt="icon1"></span>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon2.png" alt="icon1"></span>
                        <h6>Skilled Chefs</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/../images/img/icon3.png" alt="icon1"></span>
                        <h6>Best Bar</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon4.png" alt="icon1"></span>
                        <h6>Vegan Cuisine</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon5.png" alt="icon1"></span>
                        <h6>Free Support</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon6.png" alt="icon1"></span>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon7.png" alt="icon1"></span>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon8.png" alt="icon1"></span>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon9.png" alt="icon1"></span>
                        <h6>Order Tokan</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon10.png" alt="icon1"></span>
                        <h6>Table Service</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="item"><span class="icon "> <img class="animate__animated animate__headShake"
                                src="../asset/images/img/icon11.png" alt="icon1"></span>
                        <h6>Awesome Team</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsam! Porro, nisi.</p>
                    </div>
                </div>
                ...
                <div class=" col-md-3">
                    <div class="item"><span class="icon feature_box_col_12"> <img
                                class="animate__animated animate__headShake" src="../asset/images/img/icon12.png" alt="icon1"></span>
